        ...
        public async Task<string> GetCounselingSummary(string emotionsTimeSeries)
        {
            try
            {
                    ...
                    Messages =
                {
                    ...
                    new ChatRequestSystemMessage($"Act as an expert counselor and provide me counseling summary based on the series of emotions that I went through this day, where timestamp start and end is in unixtimestamp format." +
                    ...
                    $"Here is the emotion: \\n"),
                    new ChatRequestUserMessage(emotionsTimeSeries),
                },
